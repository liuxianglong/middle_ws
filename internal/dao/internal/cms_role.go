...
// CmsRoleColumns defines and stores column names for the table cms_role.
type CmsRoleColumns struct {
	Id string //
}

// cmsRoleColumns holds the columns for the table cms_role.
var cmsRoleColumns = CmsRoleColumns{
	Id: "id",
}

// NewCmsRoleDao creates and returns a new DAO object for table data access.
func NewCmsRoleDao(handlers ...gdb.ModelHandler) *CmsRoleDao {
	return &CmsRoleDao{
		group:    "default",
		table:    "cms_role",
