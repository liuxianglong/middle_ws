...
type DemoData struct {
	...
	Next uint32 `protobuf:"varint,1,opt,name=next,proto3" json:"next" dc:"下一页"`
}
...
func (x *DemoData) GetNext() uint32 {
	if x != nil {
		return x.Next
	}
	return 0
...
var file_api_demo_proto_rawDesc = []byte{
	...
	0x12, 0x02, 0x70, 0x62, 0x22, 0x1e, 0x0a, 0x08, 0x44, 0x65, 0x6d, 0x6f, 0x44, 0x61, 0x74, 0x61,
	0x12, 0x12, 0x0a, 0x04, 0x6e, 0x65, 0x78, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x04,
	0x6e, 0x65, 0x78, 0x74, 0x42, 0x07, 0x5a, 0x05, 0x2e, 0x2e, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70,
...
var file_api_demo_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_api_demo_proto_goTypes = []interface{}{
	(*DemoData)(nil), // 0: pb.DemoData
}
